...
import { JewelleryPhotoGraphyGallerySection,JewelleryPhotoGraphyHeroSection } from '@/utils/seoMap';
...
const jewelleryPhotography = () => {
    const pageURL = 'https://www.unstudio.ai/jewellery-photography';
        ...
        <Layout>
            <>
                <NextSeo
                    ...
                    description="Affordable jewellery photography with the best AI photography tool in town."
                    canonical={pageURL}
                    instagram={{
                        handle: "@unstudio.ai",
                        site: "@unstudio.ai",
            ...
            <div className=" max-w-[1750px] mx-auto">
                ...
                <Section className='flex flex-col md:flex-row  gap-12 sm:gap-4 justify-between md:items-center px-6 md:px-14 lg:px-20'>
                    <div className='flex flex-col gap-4 font-poppin '>
                        ...
                        <h3 className='text-xl lg:text-2xl leading-7 tracking-wide'>Affordable jewellery photography with the best AI photography tool in town</h3>

                        <HeroButton />
                    </div>
                    <div className='w-full px-2 sm:px-0 md:w-1/2 overflow-hidden'>
                        <HeroGallery data={JewelleryPhotoGraphyHeroSection} />
                    </div>
                </Section>
                ...
                <Section className='mx-2 md:mx-14 lg:mx-20'>
                    <h1 className='text-center font-bold font-poppin leading-7 md:leading-10 tracking-wide text-xl md:text-xl lg:text-4xl'>
                        jewellery product photography that doesn't cost as much as the piece.<br />
                    </h1>
                    <h1 className='text-center mt-2 font-poppin md:leading-8 tracking-wide text-lg md:text-xl lg:text-3xl'>
                        Stand out from the crowd, and choose from 500+ templates to create unique AI-generated jewellery photos.
                    </h1>

                    <h1 className='text-center mt-4 font-poppin md:leading-8 tracking-wide text-sm md:text-xl lg:text-lg'>
                        Here's the outcome other users got from our app testing for jewellery <br /> Unstudio pictures. If they can, so can you.</h1>

                    <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 px-3 sm:mx-0 xl:grid-cols-5 mt-16 gap-3'>
                        {JewelleryPhotoGraphyGallerySection().map((item, idx) => (
