...
import { CosmeticPhotoGraphyGallerySection,CosmeticPhotoGraphyHeroSection} from '@/utils/seoMap';
...
const CosmeticPhotography = () => {
    const pageURL = 'https://www.unstudio.ai/cosmetic-photography';
  ...
  return (
    ...
    <NextSeo
        title="Create Stunning Product Visuals using AI, instantly | Unstudio"
                  description=" Generate AI skincare photos for every skin type with Unstudio."
        canonical={pageURL}
        instagram={{
          handle: "@unstudio.ai",
          site: "@unstudio.ai",
          ...
          <div className=" max-w-[1750px] mx-auto">
              ...
              <Section className='flex flex-col md:flex-row  gap-12 sm:gap-4 justify-between md:items-center px-6 md:px-14 lg:px-20'>
                  <div className='flex flex-col gap-4 font-poppin '>
                      ...
                      <h3 className='text-xl lg:text-2xl leading-7 tracking-wide'>Generate AI Skincare Photos for Every Skin Type</h3>

                      <HeroButton />
                  </div>
                  <div className='w-full px-2 sm:px-0 md:w-1/2 overflow-hidden'>
                      <HeroGallery data={CosmeticPhotoGraphyHeroSection} />
                  </div>
              </Section>
...
export default CosmeticPhotography